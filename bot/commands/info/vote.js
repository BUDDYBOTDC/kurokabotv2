...
module.exports = {
    ...
    execute: async (client = new Client(), message = new Message(), args = []) => {
        ...
        .setURL("https://top.gg/bot/754024463137243206/vote")
        .setDescription(`By voting [here](https://top.gg/bot/754024463137243206/vote) you won't get anything at all, but remember the bot's completely free and we'd like our users to value our effort put into this bot by making it full free!`)
