...
Found a bug? Report it on our [Support Server](https://discord.gg/f7MCvQJ)! (or use \`k!support\` if you can't click hyperlink ) \n Support the bot with a vote by clicking [here](https://discord.boats/bot/kuroka) `)
