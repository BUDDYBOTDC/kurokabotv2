...
module.exports = {
    ...
    execute: async (client = new Client(), message =new Message(), args = [], db) => {
        ...
        const fields = `roles <roleID | @role> ... [filter: --single]
messages <number>
member_older <days>
account_older <days>
user_tag_equals <tag>
...
`)
        ...
        async function sixth() {
            ...
            embed.addField(`Vote ${client.user.username}`, `You can vote this bot [here](https://top.gg/bot/754024463137243206/vote) if you like all this features that we provide for free :3`)
